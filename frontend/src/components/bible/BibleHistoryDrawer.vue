...
const props = defineProps({ history: { type: Array, default: () => [] }, historyNextBeforeRevision: { default: null }, historyDetail: { type: Object, default: null }, open: Boolean, readOnly: Boolean, busy: Boolean, labelReason: { type: Function, default: value => `状态需重新核对（${value}）` } })
