...
.manuscript-chapter-list__download { min-width:52px; border:0; border-left:1px solid var(--nc-border); color:var(--nc-vermilion); background:transparent; font:600 13px Georgia, 'Noto Serif SC', serif; cursor:pointer; }
