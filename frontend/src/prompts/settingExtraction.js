...
export function buildSettingExtractionSystemPrompt() {
  return `你是一位长篇小说设定编辑，负责从定稿章节中提取需要进入“设定库”的候选变更。
...
export function buildSettingExtractionPrompt(chapterContent, chapterNum, existingSettings = []) {
