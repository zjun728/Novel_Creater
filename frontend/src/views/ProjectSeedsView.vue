...
const selectionSource = computed(() => presentSeedProvenance(selectionTarget.value?.provenance))
...
<template>
  ...
  <FoundationWorkspace v-else title="创作种子" purpose="确认前逐区校订候选；确认后，所选修订将作为项目永久创作基线。" :status-label="confirmedSeed ? '已确认 / 已冻结' : '待确认'" :read-only="mainReadOnly">
