...
const { working, confirmOpen, historyOpen, errorSummary, recoveryCommand, busy, mode, activeStatus, editable, canSave, canConfirm, confirmPreview, reasonLabels, cloneSource } = workspace
