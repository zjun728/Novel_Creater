...
Verify all 10 style templates and exactly 64 experience cards against the approved human criteria. Reports record reviewer/commit/decision and do not self-award quality.
...
Expected: schema v1.1, project1/seeds3/selected典镇山河, current Providers preserved, binding revision1/eight ready, contract head0, 10 style heads, 64 card heads, Canon/Projection0, later domains empty.
