...
RECORD_FIELD_ALLOWLISTS: Mapping[str, frozenset[str]] = MappingProxyType({
    ...
    "story-engine-option": frozenset({"label", "batchLogicalId", "selectionRevision", "optionOrder", "payload", "contentHash", "createdAt"}),
    "project-contract-draft": frozenset({"label", "revision", "baseHeadRevision", "selectionRevision", "seedRevisionLogicalId", "seedHash", "engineOptionLogicalId", "draftVersion", "payload", "contentHash", "createdAt", "updatedAt"}),
    "creation-contract": frozenset({"label", "revision", "selectionRevision", "seedLogicalId", "seedRevisionLogicalId", "seedHash", "bindingRevisionLogicalId", "bindingHash", "payload", "contentHash", "createdAt"}),
    "style-contract": frozenset({"label", "revision", "creationContractLogicalId", "payload", "contentHash", "createdAt"}),
    "project-contract-head": frozenset({"label", "revision", "creationContractLogicalId", "styleContractLogicalId", "contentHash", "updatedAt"}),
    "contract-confirmation": frozenset({"label", "status", "selectionRevision", "creationContractLogicalId", "styleContractLogicalId", "contractRevision", "resultRevision", "contentHash", "createdAt", "completedAt"}),
    ...
    "project-bible-draft": frozenset({"label", "revision", "baseHeadRevision", "selectionRevision", "seedLogicalId", "seedRevisionLogicalId", "seedHash", "contractRevision", "creationContractLogicalId", "creationHash", "styleContractLogicalId", "styleHash", "bindingRevisionLogicalId", "bindingHash", "policyVersion", "draftVersion", "payload", "contentHash", "createdAt", "updatedAt"}),
    ...
    "creation-bible-revision": frozenset({
        "label", "revision", "selectionRevision", "seedLogicalId", "seedRevisionLogicalId", "seedHash",
        "contractRevision", "creationContractLogicalId", "creationHash", "styleContractLogicalId", "styleHash",
        "bindingRevisionLogicalId", "bindingHash", "policyVersion", "payload", "contentHash", "createdAt",
    }),
    "project-bible-head": frozenset({"label", "revision", "bibleRevisionLogicalId", "contentHash", "updatedAt"}),
    "bible-confirmation": frozenset({"label", "status", "selectionRevision", "contractRevision", "creationContractLogicalId", "creationHash", "styleContractLogicalId", "styleHash", "draftLogicalId", "draftVersion", "draftHash", "bibleRevision", "bibleRevisionLogicalId", "resultRevision", "contentHash", "createdAt", "completedAt"}),
    "planning-draft": frozenset({"label", "revision", "baseHeadRevision", "draftRevision", "selectionRevision", "seedLogicalId", "seedRevisionLogicalId", "seedHash", "contractRevision", "creationContractLogicalId", "creationHash", "styleContractLogicalId", "styleHash", "bibleRevision", "bibleRevisionLogicalId", "bibleHash", "payload", "contentHash", "createdAt", "updatedAt"}),
    ...
    "planning-confirmation": frozenset({"label", "status", "draftLogicalId", "draftRevision", "draftHash", "expectedHeadRevision", "planningRevision", "planningRevisionLogicalId", "resultRevision", "contentHash", "createdAt", "completedAt"}),
    "chapter-outline-draft": frozenset({"label", "chapterNumber", "revision", "baseHeadRevision", "draftRevision", "planningRevisionLogicalId", "planningRevision", "planningHash", "canonRevision", "projectionRevision", "projectionHash", "payload", "contentHash", "createdAt", "updatedAt"}),
    ...
    "chapter-outline-confirmation": frozenset({"label", "status", "chapterNumber", "draftLogicalId", "draftRevision", "draftHash", "expectedHeadRevision", "planningRevisionLogicalId", "planningRevision", "planningHash", "canonRevision", "projectionRevision", "projectionHash", "outlineRevision", "outlineRevisionLogicalId", "resultRevision", "contentHash", "createdAt", "completedAt"}),
