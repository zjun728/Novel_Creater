CREATE TABLE project_bible_drafts (
  ...
  UNIQUE KEY uq_bible_draft_generation (project_id, id, selection_revision, contract_revision, contract_hash),
...
CREATE TABLE creation_bible_revisions (
  ...
  UNIQUE KEY uq_bible_revision_generation (project_id, selection_revision, contract_revision, contract_hash, revision, content_hash),
  UNIQUE KEY uq_bible_revision_full_generation (project_id, id, selection_revision, contract_revision, contract_hash, revision, content_hash),
  FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE,
  FOREIGN KEY (project_id, selection_revision, seed_id, seed_revision_id, seed_hash) REFERENCES project_seed_selection_revisions(project_id, selection_revision, seed_id, seed_revision_id, seed_hash) ON DELETE RESTRICT,
  FOREIGN KEY (project_id, selection_revision, contract_revision, contract_hash) REFERENCES creation_contracts(project_id, selection_revision, revision, content_hash) ON DELETE RESTRICT,
  FOREIGN KEY (project_id, binding_revision_id, binding_hash) REFERENCES project_model_binding_revisions(project_id, id, content_hash) ON DELETE RESTRICT,
...
CREATE TABLE bible_confirmation_requests (
  ...
  FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE,
  FOREIGN KEY (project_id, selection_revision, contract_revision, contract_hash) REFERENCES creation_contracts(project_id, selection_revision, revision, content_hash) ON DELETE RESTRICT,
  FOREIGN KEY (project_id, draft_id, selection_revision, contract_revision, contract_hash) REFERENCES project_bible_drafts(project_id, id, selection_revision, contract_revision, contract_hash) ON DELETE RESTRICT,
  FOREIGN KEY (project_id, bible_revision_id, selection_revision, contract_revision, contract_hash, result_revision, result_hash) REFERENCES creation_bible_revisions(project_id, id, selection_revision, contract_revision, contract_hash, revision, content_hash) ON DELETE RESTRICT,
  CHECK (selection_revision > 0),
  CHECK (contract_revision > 0),
  CHECK (draft_version > 0),
