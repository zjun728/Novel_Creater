CREATE TABLE chapter_sessions (
  ...
  UNIQUE KEY uq_chapter_session_num (project_id, selection_revision, contract_revision, contract_hash, bible_revision, bible_hash, volume_plan_id, planning_manifest_hash, chapter_num),
  UNIQUE KEY uq_chapter_session_project_id (project_id, id),
  FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE,
  FOREIGN KEY (project_id, volume_plan_id, selection_revision, contract_revision, contract_hash, bible_revision, bible_hash, planning_manifest_hash) REFERENCES volume_plans(project_id, id, selection_revision, contract_revision, contract_hash, bible_revision, bible_hash, manifest_hash) ON DELETE RESTRICT,
