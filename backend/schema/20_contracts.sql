...
CREATE TABLE creation_contracts (
  ...
  UNIQUE KEY uq_creation_contract_head_identity (project_id, id, revision, content_hash),
  UNIQUE KEY uq_creation_contract_generation (project_id, selection_revision, revision, content_hash),
  UNIQUE KEY uq_creation_contract_generation_id (project_id, selection_revision, id, revision),
  FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE,
  FOREIGN KEY (project_id, selection_revision, seed_id, seed_revision_id, seed_hash) REFERENCES project_seed_selection_revisions(project_id, selection_revision, seed_id, seed_revision_id, seed_hash) ON DELETE RESTRICT,
  FOREIGN KEY (project_id, seed_id, seed_revision_id, seed_hash) REFERENCES creative_seed_revisions(project_id, seed_id, id, content_hash) ON DELETE RESTRICT,
  FOREIGN KEY (project_id, binding_revision_id, binding_hash) REFERENCES project_model_binding_revisions(project_id, id, content_hash) ON DELETE RESTRICT,
...
CREATE TABLE style_contracts (
  ...
  UNIQUE KEY uq_style_contract_head_identity (project_id, id, revision, content_hash),
  FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE,
...
CREATE TABLE project_contract_heads (
  ...
  updated_at BIGINT NOT NULL,
  FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE,
  FOREIGN KEY (project_id, creation_contract_id, revision, creation_hash) REFERENCES creation_contracts(project_id, id, revision, content_hash) ON DELETE RESTRICT,
  FOREIGN KEY (project_id, style_contract_id, revision, style_hash) REFERENCES style_contracts(project_id, id, revision, content_hash) ON DELETE RESTRICT,
  CHECK (revision >= 0),
...
CREATE TABLE contract_confirmation_requests (
  ...
  FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE,
  FOREIGN KEY (project_id, selection_revision) REFERENCES project_seed_selection_revisions(project_id, selection_revision) ON DELETE RESTRICT,
  FOREIGN KEY (project_id, selection_revision, creation_contract_id, result_revision) REFERENCES creation_contracts(project_id, selection_revision, id, revision) ON DELETE RESTRICT,
...
CREATE TABLE style_contract_template_refs (
  ...
  FOREIGN KEY (style_contract_id) REFERENCES style_contracts(id) ON DELETE CASCADE,
